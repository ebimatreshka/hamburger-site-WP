...
<main class="l-main__archive p-main__archive c-grid__main c-bg-color--egg">
    <div class="p-main-visual__archive c-background__archive c-pseudo-element__black">
        ...
        <p class="p-main-visual__archive__detail c-font__M--bold c-font-size__16 c-color__white"><?php echo get_search_query(); ?></p>
    </div>
    ...
    <?php if (have_posts()) : ?>
        ...
        <?php endwhile; ?>
    <?php else : ?>
        <p class="wp-search">お探しのページは見つかりませんでした。</p>
    <?php endif; ?>
